...
const RankingSemanal = ({ usuario, sidebar }) => {
    ...
    if (sidebar) {
        return (
            <div style={{ width: '280px', flexShrink: 0, background: 'linear-gradient(180deg, rgba(255,214,0,0.04) 0%, rgba(0,0,0,0.3) 100%)', borderRadius: '16px', border: '1px solid rgba(255,214,0,0.12)', padding: '14px', position: 'sticky', top: '10px', alignSelf: 'flex-start', maxHeight: 'calc(100vh - 120px)', overflowY: 'auto' }}>
